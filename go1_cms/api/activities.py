...
def get_activities(name):
		if frappe.db.exists("CMS_JobOpening", name):
			return get_cms_jobopening_activities(name,"CMS_JobOpening")
		else:
...
def get_cms_jobopening_activities(name,doctype_param):
	get_docinfo('',doctype_param, name)
	docinfo = frappe.response["docinfo"]
	lead_meta = frappe.get_meta(doctype_param)
	lead_fields = {field.fieldname: {"label": field.label, "options": field.options} for field in lead_meta.fields}
...
def get_ats_jobopening_activities(name,doctype_param):
	get_docinfo('',doctype_param, name)
	docinfo = frappe.response["docinfo"]
	lead_meta = frappe.get_meta(doctype_param)
	lead_fields = {field.fieldname: {"label": field.label, "options": field.options} for field in lead_meta.fields}
...
def get_ats_candidate_activities(name,doctype_param):
	get_docinfo('',doctype_param, name)
	docinfo = frappe.response["docinfo"]
	lead_meta = frappe.get_meta(doctype_param)
	lead_fields = {field.fieldname: {"label": field.label, "options": field.options} for field in lead_meta.fields}
