<template>
	...
	<QuickEntryModal v-model="showQuickEntryModal" doctype="ATS_Position" />
</template>
...
import Modal from "@/components/Modals/ATS_Position_Modal.vue";
import DataListView from "@/components/ListViews/ATS_Position_ListView.vue";
...
const canCreate = can("ATS_Position", "create");

const breadcrumbs = [{ label: __("Position"), route: { name: "Position" } }];
