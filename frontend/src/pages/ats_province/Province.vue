<template>
	...
	<QuickEntryModal v-model="showQuickEntryModal" doctype="ATS_Province" />
</template>
...
import Modal from "@/components/Modals/ATS_Province_Modal.vue";
import DataListView from "@/components/ListViews/ATS_Province_ListView.vue";
...
const canCreate = can("ATS_Province", "create");

const breadcrumbs = [{ label: __("Province"), route: { name: "Province" } }];
