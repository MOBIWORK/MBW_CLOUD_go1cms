<template>
	...
	<QuickEntryModal v-model="showQuickEntryModal" doctype="ATS_Ward" />
</template>
...
import Modal from "@/components/Modals/ATS_Ward_Modal.vue";
import DataListView from "@/components/ListViews/ATS_Ward_ListView.vue";
...
const canCreate = can("ATS_Ward", "create");

const breadcrumbs = [{ label: __("Ward"), route: { name: "Ward" } }];
