<template>
	...
	<QuickEntryModal v-model="showQuickEntryModal" doctype="ATS_Location" />
</template>
...
import Modal from "@/components/Modals/ATS_Location_Modal.vue";
import DataListView from "@/components/ListViews/ATS_Location_ListView.vue";
...
const canCreate = can("ATS_Location", "create");

const breadcrumbs = [{ label: __("Location"), route: { name: "Location" } }];
