<template>
	...
	<QuickEntryModal v-model="showQuickEntryModal" doctype="ATS_District" />
</template>
...
import Modal from "@/components/Modals/ATS_District_Modal.vue";
import DataListView from "@/components/ListViews/ATS_District_ListView.vue";
...
const canCreate = can("ATS_District", "create");

const breadcrumbs = [{ label: __("District"), route: { name: "District" } }];
