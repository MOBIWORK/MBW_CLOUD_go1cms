<template>
	...
	<QuickEntryModal v-model="showQuickEntryModal" doctype="ATS_Country" />
</template>
...
import Modal from "@/components/Modals/ATS_Country_Modal.vue";
import DataListView from "@/components/ListViews/ATS_Country_ListView.vue";
...
const canCreate = can("ATS_Country", "create");

const breadcrumbs = [{ label: __("Country"), route: { name: "Country" } }];
