      ...
      <div class="flex flex-col gap-3">
        ...
        <div v-if="tabs?.data">
          <FieldLayoutEditor
            ...
            :doctype="_doctype"
          />
          <FieldLayout v-else :tabs="tabs.data" :data="{}" :preview="true" :doctype="props.doctype"/>
        </div>
      </div>
    </template>
  </Dialog>
...
function saveChanges() {
  ...
  console.log("Test log _tabs : >>>>>>>>>>>>>",_tabs)
  _tabs.forEach((tab) => {
  ...
  call( 
    ...
    quickEntryDoctype.setDoctypeQuickEntry(props.doctype)
  })
}
</script>
