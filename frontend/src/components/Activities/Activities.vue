<template>
	...
	<FadedScrollableDiv :maskHeight="30" class="flex flex-col flex-1 overflow-y-auto">
		...
		<!-- <div v-else-if="title == 'Data'" class="h-full flex flex-col px-3 sm:px-10">
			<DataFields :doctype="doctype" :docname="doc.data.name" :data="doc.data"/>
		</div> -->
		<div
			v-else
			class="flex flex-1 flex-col items-center justify-center gap-3 text-xl font-medium text-gray-500"
...
const props = defineProps({
	doctype: {
		type: String,
		default: "ATS_JobOpening",
	},
	isActionMenuEmployee: {
		type: Boolean,
	},
	isCheckChangeStatusUpdateEmployee: {
		type: String,
		required: true,
	},
	isReloadData: {
...
const emit = defineEmits(["handleAddBangKe"]);
...
const all_activities = createResource({
	url: "go1_cms.api.activities.get_activities",
