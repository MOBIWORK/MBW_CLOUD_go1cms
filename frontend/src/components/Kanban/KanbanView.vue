        ...
        >
          <div class="flex gap-2 items-center group justify-between">
            <div class="flex items-center text-base">
              ...
              <div class="text-ink-gray-9">{{ column.column.name }} ( <span class="font-bold text-lg">{{ column.data.length }}</span> )</div>
            </div>
            <div class="flex">
            ...
            >
              <template #item="{ element: fields }">
                <component
                  ...
                  class="pt-3 px-3.5 pb-2.5 rounded-lg border bg-surface-white text-base flex flex-col text-ink-gray-9 cursor-pointer"
